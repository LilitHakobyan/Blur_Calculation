...
namespace EdgeDetactionProject
{
    ...
    public partial class MainWindow : Window
    {
        ...
        private void MainWindow_Loaded(object sender, RoutedEventArgs e)
        {
            ...
            listOfImage = new List<MatrixDetection>(); // dal.ImageDal.GetAll();//.GetAllRoots();
            imgDataGrid.ItemsSource = listOfImage;
            imgDataGrid.Visibility = Visibility.Hidden;
        }
        private void Browse_Click(object sender, RoutedEventArgs e)
        {
            ...
            else
            {
                ...
                dlg.DefaultExt = "BMP Files (*.bmp)|*.bmp";
        ...
        private void Magnitude_Click(object sender, RoutedEventArgs e)
        {
            ...
            if (i > -1)
            {
                ...
                var image = new MatrixDetection() { Name = rowobj.Name+"_M", Component = rowobj.Component, Height = sobelMagMatrix.GetLength(1), Type = "SobelM", Width = sobelMagMatrix.GetLength(0), Matrix = arrM };
                dal.ImageDal.Add(image);
        ...
        private void SobelV_Click(object sender, RoutedEventArgs e)
        {
            ...
            if (i > -1)
            {
                ...
                var image = new MatrixDetection() { Name = rowobj.Name+"_V", Component = rowobj.Component, Height = rowobj.Height, Type = "SobelV", Width = rowobj.Width, Matrix = arrM };
                dal.ImageDal.Add(image);
        ...
        private void SobelH_Click(object sender, RoutedEventArgs e)
        {
            ...
            if (i > -1)
            {
                ...
                var image = new MatrixDetection() { Name = rowobj.Name+"_H", Component = rowobj.Component, Height = rowobj.Height, Type = "SobelH", Width = rowobj.Width, Matrix = arrM };
                dal.ImageDal.Add(image);
        ...
        private void LoadAndCalcFromFolder_Click(object sender, RoutedEventArgs e)
        {
            ...
            foreach (var img in images)
            {
                ...
                var imageSV = new MatrixDetection() { Name = filename+"_V", Component = imageD.Component, Height = h, Type = "SobelV", Width = w, Matrix = arrSV};
                ...
                var imageSH = new MatrixDetection() { Name = filename+"_H", Component = imageD.Component, Height = h, Type = "SobelH", Width = w, Matrix = arrSH};
                ...
                var arrM = core.Image.ConvertMatreixToArray(core.Image.Normalize(sobelMagMatrix));
                var imageM = new MatrixDetection() { Name = filename+"_M", Component = imageD.Component, Height = sobelMagMatrix.GetLength(1), Type = "SobelM", Width = sobelMagMatrix.GetLength(0), Matrix = arrM };
        ...
        private void BlurMapCalcLoacliy_Click(object sender, RoutedEventArgs e)
        {
         ...
         //   var arrM = core.Image.ConvertMatreixToArray(matrix);
           // var imageD = new MatrixDetection() { Name = filename, Component = "R", Height = h, Type = Convert.ToString(MatrixTypes.Default), Width = w, Matrix = arrM };            
            ...
            var sobelMagMatrix = core.Image.MagnitudeFromDefoultMatrix(matrix); //1 step
            core.Localization.SaveMatrix(sobelMagMatrix, filename + "_Magnitude");//core.Image.NormalizeMatrixByte(

            var calcM = core.Image.CalcBlurMapDouble(sobelMagMatrix); // 2 step need to change estim
            var calcMNormalazed = core.Image.NormalizeMatrix(calcM);
           // var arrM = core.Image.ConvertMatreixToArrayint(core.Image.NormalizeD(calcM));
            //var arrM = core.Image.NormalizeInt(calcM);
            Bitmap img = core.Image.ConvertArrayToImage(core.Image.ConvertMatreixToArrayint(calcMNormalazed),calcMNormalazed.GetLength(0),calcMNormalazed.GetLength(1));// FromTwoDimIntArrayGray(calcMNormalazed);//, w - 2, h - 2);

            core.Localization.SaveMatrix(calcM, filename +"_Map");//core.Image.NormalizeMatrixByte(
        ...
        private void imgpathtextbox_ImageFailed(object sender, ExceptionRoutedEventArgs e)
        {
